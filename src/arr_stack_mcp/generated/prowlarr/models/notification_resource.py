...
class NotificationResource:
    ...
    Attributes:
        ...
        include_manual_grabs (Union[Unset, bool]):
    ...
    include_manual_grabs: Union[Unset, bool] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        include_manual_grabs = self.include_manual_grabs
        ...
        if include_manual_grabs is not UNSET:
            field_dict["includeManualGrabs"] = include_manual_grabs
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        include_manual_grabs = d.pop("includeManualGrabs", UNSET)
        ...
        notification_resource = cls(
            ...
            include_manual_grabs=include_manual_grabs,
