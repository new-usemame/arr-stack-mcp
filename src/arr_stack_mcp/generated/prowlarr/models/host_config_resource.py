...
class HostConfigResource:
    ...
    Attributes:
        ...
        history_cleanup_days (Union[Unset, int]):
    ...
    history_cleanup_days: Union[Unset, int] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        history_cleanup_days = self.history_cleanup_days
        ...
        if history_cleanup_days is not UNSET:
            field_dict["historyCleanupDays"] = history_cleanup_days
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        password_confirmation = _parse_password_confirmation(
            d.pop("passwordConfirmation", UNSET)
        )
        ...
        proxy_bypass_filter = _parse_proxy_bypass_filter(
            d.pop("proxyBypassFilter", UNSET)
        )
        ...
        history_cleanup_days = d.pop("historyCleanupDays", UNSET)
        ...
        host_config_resource = cls(
            ...
            history_cleanup_days=history_cleanup_days,
