...
T = TypeVar("T", bound="ApplicationResource")
...
class ApplicationResource:
    ...
    Attributes:
        ...
        presets (Union[None, Unset, list['ApplicationResource']]):
    ...
    presets: Union[None, Unset, list["ApplicationResource"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_presets(
            data: object,
        ) -> Union[None, Unset, list["ApplicationResource"]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for presets_type_0_item_data in _presets_type_0:
                    presets_type_0_item = ApplicationResource.from_dict(
                ...
                pass
            return cast(Union[None, Unset, list["ApplicationResource"]], data)
