...
T = TypeVar("T", bound="IndexerProxyResource")


@_attrs_define
class IndexerProxyResource:
    """
    Attributes:
        id (Union[Unset, int]):
        ...
        presets (Union[None, Unset, list['IndexerProxyResource']]):
    ...
    presets: Union[None, Unset, list["IndexerProxyResource"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_presets(
            data: object,
        ) -> Union[None, Unset, list["IndexerProxyResource"]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for presets_type_0_item_data in _presets_type_0:
                    presets_type_0_item = IndexerProxyResource.from_dict(
                ...
                pass
            return cast(Union[None, Unset, list["IndexerProxyResource"]], data)
