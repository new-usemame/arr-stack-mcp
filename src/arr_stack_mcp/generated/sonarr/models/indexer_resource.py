...
class IndexerResource:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        season_search_maximum_single_episode_age = (
            self.season_search_maximum_single_episode_age
        )
        ...
        if season_search_maximum_single_episode_age is not UNSET:
            field_dict["seasonSearchMaximumSingleEpisodeAge"] = (
                season_search_maximum_single_episode_age
            )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        season_search_maximum_single_episode_age = d.pop(
            "seasonSearchMaximumSingleEpisodeAge", UNSET
        )
