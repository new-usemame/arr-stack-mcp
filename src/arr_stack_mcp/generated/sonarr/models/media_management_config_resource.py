...
class MediaManagementConfigResource:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        auto_unmonitor_previously_downloaded_episodes = (
            self.auto_unmonitor_previously_downloaded_episodes
        )
        ...
        if auto_unmonitor_previously_downloaded_episodes is not UNSET:
            field_dict["autoUnmonitorPreviouslyDownloadedEpisodes"] = (
                auto_unmonitor_previously_downloaded_episodes
            )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        auto_unmonitor_previously_downloaded_episodes = d.pop(
            "autoUnmonitorPreviouslyDownloadedEpisodes", UNSET
        )
