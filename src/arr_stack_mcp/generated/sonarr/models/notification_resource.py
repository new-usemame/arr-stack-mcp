...
class NotificationResource:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        supports_on_episode_file_delete_for_upgrade = (
            self.supports_on_episode_file_delete_for_upgrade
        )
        ...
        if on_episode_file_delete_for_upgrade is not UNSET:
            field_dict["onEpisodeFileDeleteForUpgrade"] = (
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        on_episode_file_delete_for_upgrade = d.pop(
            "onEpisodeFileDeleteForUpgrade", UNSET
        )
