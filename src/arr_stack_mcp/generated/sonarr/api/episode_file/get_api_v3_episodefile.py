...
def _get_kwargs(
    *,
    ...
    episode_file_ids: Union[Unset, list[int]] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}

    params["seriesId"] = series_id

    json_episode_file_ids: Union[Unset, list[int]] = UNSET
...
) -> Optional[list["EpisodeFileResource"]]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        episode_file_ids (Union[Unset, list[int]]):
