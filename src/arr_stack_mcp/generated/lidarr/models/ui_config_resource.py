...
class UiConfigResource:
    ...
    Attributes:
        ...
        expand_album_by_default (Union[Unset, bool]):
        expand_single_by_default (Union[Unset, bool]):
        expand_ep_by_default (Union[Unset, bool]):
        expand_broadcast_by_default (Union[Unset, bool]):
        expand_other_by_default (Union[Unset, bool]):
    ...
    expand_album_by_default: Union[Unset, bool] = UNSET
    expand_single_by_default: Union[Unset, bool] = UNSET
    expand_ep_by_default: Union[Unset, bool] = UNSET
    expand_broadcast_by_default: Union[Unset, bool] = UNSET
    expand_other_by_default: Union[Unset, bool] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        expand_album_by_default = self.expand_album_by_default

        expand_single_by_default = self.expand_single_by_default

        expand_ep_by_default = self.expand_ep_by_default

        expand_broadcast_by_default = self.expand_broadcast_by_default

        expand_other_by_default = self.expand_other_by_default
        ...
        if expand_album_by_default is not UNSET:
            field_dict["expandAlbumByDefault"] = expand_album_by_default
        if expand_single_by_default is not UNSET:
            field_dict["expandSingleByDefault"] = expand_single_by_default
        if expand_ep_by_default is not UNSET:
            field_dict["expandEPByDefault"] = expand_ep_by_default
        if expand_broadcast_by_default is not UNSET:
            field_dict["expandBroadcastByDefault"] = expand_broadcast_by_default
        if expand_other_by_default is not UNSET:
            field_dict["expandOtherByDefault"] = expand_other_by_default
    ...
    def from_dict(cls, src_dict):
        ...
        expand_album_by_default = d.pop("expandAlbumByDefault", UNSET)

        expand_single_by_default = d.pop("expandSingleByDefault", UNSET)

        expand_ep_by_default = d.pop("expandEPByDefault", UNSET)

        expand_broadcast_by_default = d.pop("expandBroadcastByDefault", UNSET)

        expand_other_by_default = d.pop("expandOtherByDefault", UNSET)
        ...
        ui_config_resource = cls(
            ...
            expand_album_by_default=expand_album_by_default,
            expand_single_by_default=expand_single_by_default,
            expand_ep_by_default=expand_ep_by_default,
            expand_broadcast_by_default=expand_broadcast_by_default,
            expand_other_by_default=expand_other_by_default,
            theme=theme,
        )
