...
T = TypeVar("T", bound="AlbumResourcePagingResource")


@_attrs_define
class AlbumResourcePagingResource:
    """
    Attributes:
        ...
        records (Union[None, Unset, list['AlbumResource']]):
    """
    ...
    records: Union[None, Unset, list["AlbumResource"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_records(data: object) -> Union[None, Unset, list["AlbumResource"]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for records_type_0_item_data in _records_type_0:
                    records_type_0_item = AlbumResource.from_dict(
        ...
        album_resource_paging_resource = cls(
            page=page,
            page_size=page_size,
            sort_key=sort_key,
        ...
        return album_resource_paging_resource
