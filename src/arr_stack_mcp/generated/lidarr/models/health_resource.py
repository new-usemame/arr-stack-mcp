...
class HealthResource:
    ...
    wiki_url: Union[None, Unset, str] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        wiki_url: Union[None, Unset, str]
        if isinstance(self.wiki_url, Unset):
            wiki_url = UNSET
        else:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_wiki_url(data: object) -> Union[None, Unset, str]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        wiki_url = _parse_wiki_url(d.pop("wikiUrl", UNSET))
