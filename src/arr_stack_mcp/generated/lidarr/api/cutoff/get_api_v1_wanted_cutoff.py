...
from ...models.album_resource_paging_resource import AlbumResourcePagingResource
...
) -> Optional[AlbumResourcePagingResource]:
    if response.status_code == 200:
        response_200 = AlbumResourcePagingResource.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[AlbumResourcePagingResource]:
    return Response(
