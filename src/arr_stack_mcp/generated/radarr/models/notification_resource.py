...
class NotificationResource:
    ...
    Attributes:
        ...
        on_movie_added (Union[Unset, bool]):
        on_movie_delete (Union[Unset, bool]):
        on_movie_file_delete (Union[Unset, bool]):
        on_movie_file_delete_for_upgrade (Union[Unset, bool]):
        ...
        supports_on_movie_added (Union[Unset, bool]):
        supports_on_movie_delete (Union[Unset, bool]):
        supports_on_movie_file_delete (Union[Unset, bool]):
        supports_on_movie_file_delete_for_upgrade (Union[Unset, bool]):
    ...
    on_movie_added: Union[Unset, bool] = UNSET
    on_movie_delete: Union[Unset, bool] = UNSET
    on_movie_file_delete: Union[Unset, bool] = UNSET
    on_movie_file_delete_for_upgrade: Union[Unset, bool] = UNSET
    ...
    supports_on_movie_added: Union[Unset, bool] = UNSET
    supports_on_movie_delete: Union[Unset, bool] = UNSET
    supports_on_movie_file_delete: Union[Unset, bool] = UNSET
    supports_on_movie_file_delete_for_upgrade: Union[Unset, bool] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        on_movie_added = self.on_movie_added

        on_movie_delete = self.on_movie_delete

        on_movie_file_delete = self.on_movie_file_delete

        on_movie_file_delete_for_upgrade = self.on_movie_file_delete_for_upgrade
        ...
        supports_on_movie_added = self.supports_on_movie_added

        supports_on_movie_delete = self.supports_on_movie_delete

        supports_on_movie_file_delete = self.supports_on_movie_file_delete

        supports_on_movie_file_delete_for_upgrade = (
            self.supports_on_movie_file_delete_for_upgrade
        )
        ...
        supports_on_manual_interaction_required = (
            self.supports_on_manual_interaction_required
        )
        ...
        if on_movie_added is not UNSET:
            field_dict["onMovieAdded"] = on_movie_added
        if on_movie_delete is not UNSET:
            field_dict["onMovieDelete"] = on_movie_delete
        if on_movie_file_delete is not UNSET:
            field_dict["onMovieFileDelete"] = on_movie_file_delete
        if on_movie_file_delete_for_upgrade is not UNSET:
            field_dict["onMovieFileDeleteForUpgrade"] = on_movie_file_delete_for_upgrade
        ...
        if supports_on_movie_added is not UNSET:
            field_dict["supportsOnMovieAdded"] = supports_on_movie_added
        if supports_on_movie_delete is not UNSET:
            field_dict["supportsOnMovieDelete"] = supports_on_movie_delete
        if supports_on_movie_file_delete is not UNSET:
            field_dict["supportsOnMovieFileDelete"] = supports_on_movie_file_delete
        if supports_on_movie_file_delete_for_upgrade is not UNSET:
            field_dict["supportsOnMovieFileDeleteForUpgrade"] = (
                supports_on_movie_file_delete_for_upgrade
            )
        ...
        if supports_on_manual_interaction_required is not UNSET:
            field_dict["supportsOnManualInteractionRequired"] = (
                supports_on_manual_interaction_required
            )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        on_movie_added = d.pop("onMovieAdded", UNSET)

        on_movie_delete = d.pop("onMovieDelete", UNSET)

        on_movie_file_delete = d.pop("onMovieFileDelete", UNSET)

        on_movie_file_delete_for_upgrade = d.pop("onMovieFileDeleteForUpgrade", UNSET)
        ...
        supports_on_movie_added = d.pop("supportsOnMovieAdded", UNSET)

        supports_on_movie_delete = d.pop("supportsOnMovieDelete", UNSET)

        supports_on_movie_file_delete = d.pop("supportsOnMovieFileDelete", UNSET)

        supports_on_movie_file_delete_for_upgrade = d.pop(
            "supportsOnMovieFileDeleteForUpgrade", UNSET
        )
        ...
        supports_on_manual_interaction_required = d.pop(
            "supportsOnManualInteractionRequired", UNSET
        )
        ...
        notification_resource = cls(
            ...
            on_movie_delete=on_movie_delete,
            on_movie_file_delete=on_movie_file_delete,
            on_movie_file_delete_for_upgrade=on_movie_file_delete_for_upgrade,
            ...
            supports_on_movie_added=supports_on_movie_added,
            supports_on_movie_delete=supports_on_movie_delete,
            supports_on_movie_file_delete=supports_on_movie_file_delete,
            supports_on_movie_file_delete_for_upgrade=supports_on_movie_file_delete_for_upgrade,
