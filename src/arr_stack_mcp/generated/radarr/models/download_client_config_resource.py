...
class DownloadClientConfigResource:
    ...
    Attributes:
        ...
        check_for_finished_download_interval (Union[Unset, int]):
    ...
    check_for_finished_download_interval: Union[Unset, int] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if enable_completed_download_handling is not UNSET:
            field_dict["enableCompletedDownloadHandling"] = (
                enable_completed_download_handling
            )
        if check_for_finished_download_interval is not UNSET:
            field_dict["checkForFinishedDownloadInterval"] = (
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_download_client_working_folders(
            data: object,
        ...
        enable_completed_download_handling = d.pop(
            "enableCompletedDownloadHandling", UNSET
        )

        check_for_finished_download_interval = d.pop(
            "checkForFinishedDownloadInterval", UNSET
        )
        ...
        download_client_config_resource = cls(
            ...
            check_for_finished_download_interval=check_for_finished_download_interval,
