...
class ImportListExclusionResource:
    ...
    Attributes:
        ...
        presets (Union[None, Unset, list['ImportListExclusionResource']]):
        tmdb_id (Union[Unset, int]):
        movie_title (Union[None, Unset, str]):
        movie_year (Union[Unset, int]):
    """
    ...
    presets: Union[None, Unset, list["ImportListExclusionResource"]] = UNSET
    tmdb_id: Union[Unset, int] = UNSET
    movie_title: Union[None, Unset, str] = UNSET
    movie_year: Union[Unset, int] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if movie_year is not UNSET:
            field_dict["movieYear"] = movie_year
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_presets(
            data: object,
        ) -> Union[None, Unset, list["ImportListExclusionResource"]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for presets_type_0_item_data in _presets_type_0:
                    presets_type_0_item = ImportListExclusionResource.from_dict(
        ...
        movie_year = d.pop("movieYear", UNSET)
