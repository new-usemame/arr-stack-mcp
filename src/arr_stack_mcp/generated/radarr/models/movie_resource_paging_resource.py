...
T = TypeVar("T", bound="MovieResourcePagingResource")
...
class MovieResourcePagingResource:
    ...
    Attributes:
        ...
        records (Union[None, Unset, list['MovieResource']]):
    """
    ...
    records: Union[None, Unset, list["MovieResource"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_records(data: object) -> Union[None, Unset, list["MovieResource"]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for records_type_0_item_data in _records_type_0:
                    records_type_0_item = MovieResource.from_dict(
                ...
                pass
            return cast(Union[None, Unset, list["MovieResource"]], data)

        records = _parse_records(d.pop("records", UNSET))

        movie_resource_paging_resource = cls(
            page=page,
            page_size=page_size,
            sort_key=sort_key,
        ...
        return movie_resource_paging_resource
