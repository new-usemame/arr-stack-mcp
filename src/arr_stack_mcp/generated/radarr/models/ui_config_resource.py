...
class UiConfigResource:
    ...
    Attributes:
        ...
        movie_runtime_format (Union[Unset, MovieRuntimeFormatType]):
        ...
        movie_info_language (Union[Unset, int]):
    ...
    movie_runtime_format: Union[Unset, MovieRuntimeFormatType] = UNSET
    ...
    movie_info_language: Union[Unset, int] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        movie_runtime_format: Union[Unset, str] = UNSET
