...
def _get_kwargs(
    *,
    ...
    include_unknown_movie_items: Union[Unset, bool] = False,
    include_movie: Union[Unset, bool] = False,
    movie_ids: Union[Unset, list[int]] = UNSET,
    ...
    json_movie_ids: Union[Unset, list[int]] = UNSET
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        include_unknown_movie_items (Union[Unset, bool]):  Default: False.
        include_movie (Union[Unset, bool]):  Default: False.
        movie_ids (Union[Unset, list[int]]):
