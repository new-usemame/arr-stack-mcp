...
from ...models.movie_resource_paging_resource import MovieResourcePagingResource
...
) -> Optional[MovieResourcePagingResource]:
    if response.status_code == 200:
        response_200 = MovieResourcePagingResource.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[MovieResourcePagingResource]:
    return Response(
