...
def _get_kwargs(
    *,
    ...
    release_types: Union[Unset, list[CalendarReleaseType]] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
    ...
    json_release_types: Union[Unset, list[str]] = UNSET
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        release_types (Union[Unset, list[CalendarReleaseType]]):
